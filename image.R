...
ggsave(plot = plot, filename = paste0(name, "-screen", ".png"), path = output, height = 5, width = 15, dpi = "screen")
ggsave(plot = plot, filename = paste0(name, "-print",  ".png"), path = output, height = 5, width = 15, dpi = "print")
ggsave(plot = plot, filename = paste0(name, "-retina", ".png"), path = output, height = 5, width = 15, dpi = "retina")
